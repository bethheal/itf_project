      ...
      <Swiper pagination={pagination} modules={[Pagination]} className="mySwiper">
        <SwiperSlide>
          <div className="flex flex-col items-center text-center">
            <img
              src="" // Replace with real avatar image URL
              alt="Avatar 1"
              className="w-12 h-12 rounded-full object-cover mb-4" // Avatar image size
            />
            <p className="font-semibold ">John Doe</p>
            <p className="text-gray-600">"This is the best service I've ever used! Highly recommend it."</p>
            <div className="flex justify-center mt-10">{renderStars(5)}</div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex justify-center mt-10">{renderStars(4)}</div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex justify-center mt-10">{renderStars(3)}</div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="flex flex-col items-center text-center">
