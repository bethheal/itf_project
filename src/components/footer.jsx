...
const Footer = () => {
  return (
    <div>
     <section class="py-10 mt-24 bg-gray-50 sm:pt-16 lg:pt-24">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img class="w-auto h-9" src={logo} alt="" />
                <h5 className="text-[#A5F3FC] font-semibold">Intergrity Trust Foundation</h5>
            ...
            <div>
                ...
                <ul class="mt-6 space-y-4">
                    ...
                    <li>
                        <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Volunteer </a>
                    </li>

                    <li>
                        <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Sponsors </a>
                    </li>

                    <li>
                        <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Projects </a>
                    </li>
                </ul>
            </div>
        ...
        <p class="text-sm text-center text-gray-600">© Copyright 2024, All Rights Reserved</p>
    </div>
</section>
